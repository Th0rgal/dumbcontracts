...
25. `Compiler/Proofs/EndToEnd.lean` composes Layer 2 (CompilationModel→IR) and Layer 3 (IR→Yul) preservation theorems into a single end-to-end result. Includes universal pure arithmetic bridge theorem statements (add/sub/mul/div/mod ↔ EVMYulLean).
