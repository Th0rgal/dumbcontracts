...
425 theorems across 11 categories. 475 Foundry tests across 38 test suites. 250 covered by property tests (59% coverage, 175 proof-only exclusions). 1 documented axiom. 1 `sorry` placeholders (12 in cross-layer bridge proofs, 0 in Yul preservation — see [VERIFICATION_STATUS.md](docs/VERIFICATION_STATUS.md)).
