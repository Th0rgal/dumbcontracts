...
theorem balanceOf_preserves_state (s : ContractState) (addr : Address) :
  ...
  simp [Verity.Examples.MacroContracts.ERC20.balanceOf, getMapping, Contract.runState, Verity.bind, Bind.bind,
...
theorem allowanceOf_preserves_state (s : ContractState) (ownerAddr spender : Address) :
  ...
  simp [Verity.Examples.MacroContracts.ERC20.allowanceOf, getMapping2, Contract.runState, Verity.bind, Bind.bind,
    Verity.pure, Pure.pure]
...
theorem getTotalSupply_preserves_state (s : ContractState) :
  ...
  simp [Verity.Examples.MacroContracts.ERC20.getTotalSupply, Verity.Examples.MacroContracts.ERC20.totalSupply,
...
theorem getOwner_preserves_state (s : ContractState) :
  ...
  simp [Verity.Examples.MacroContracts.ERC20.getOwner, Verity.Examples.MacroContracts.ERC20.owner,
