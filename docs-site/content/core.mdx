...
4 out of 7 implementation iterations needed no core changes. The jump from 82 to ~234 lines was for verification infrastructure and EVM context, not contract primitives.
