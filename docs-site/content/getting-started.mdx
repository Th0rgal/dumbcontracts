...
```bash
lake exe verity-compiler    # Outputs Yul to generated/yul/
cat generated/yul/SimpleStorage.yul
```
...
```bash
lake exe verity-compiler --link examples/external-libs/PoseidonT3.yul -o generated/yul
```
