...
theorem and assumption inventory. Layer 2 proof status is tracked in
...
<ReadingList items={[
  ...
  { href: '/guides/first-contract', title: 'First Contract', note: 'A guided spec-to-proof walkthrough.' },
  { href: '/compiler', title: 'Compiler', note: 'The EDSL-to-EVM pipeline and trust model.' },
  { href: '/verification', title: 'Verification', note: 'Theorem inventory and proof status.' },
  { href: '/guides/solidity-to-verity', title: 'Solidity to Verity', note: 'Translation patterns from Solidity.' },
  { href: '/guides/production-solidity-patterns', title: 'Production patterns', note: 'Modifiers, externals, ABI, events, oracles.' },
]} />
