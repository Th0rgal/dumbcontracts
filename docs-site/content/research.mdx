...
- **Layer 3 (IR → Yul)**: In progress (generic equivalence scaffolding + Yul fuel‑unfolding lemmas + fuel‑bounded IR↔Yul sequence lemma; equivalence theorems not yet proven).
