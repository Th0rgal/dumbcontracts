...
- **Layer 3 (IR → Yul)**: In progress (IR expression-statement semantics aligned with Yul to unblock equivalence proofs; smoke tests now assert revert preservation across IR and Yul).
