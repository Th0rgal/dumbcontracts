...
- **Layer 2 (ContractSpec → IR)**: Infrastructure complete; SimpleStorage + Counter preservation proofs done; generalization in progress.
...
- Generalize the preservation proof to the remaining 5 contracts (Owned, OwnedCounter, SafeCounter, Ledger, SimpleToken).
