...
[`AXIOMS.md`](https://github.com/lfglabs-dev/verity/blob/main/AXIOMS.md). That file
...
- **Pre-computed function selectors.** Selectors are derived from
  ...
  `solc --hashes`.
- **The axioms in [`AXIOMS.md`](https://github.com/lfglabs-dev/verity/blob/main/AXIOMS.md).**
