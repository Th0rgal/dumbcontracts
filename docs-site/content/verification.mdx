...
As of 2026-02-13, the EDSL has 252 proven theorems across 7 contracts and a math stdlib. The compiler is additionally verified with IR and Yul preservation proofs in `Compiler/Proofs/`. No `sorry`, no axioms. All proofs are checked by `lake build`. The counts and lists below are a snapshot of that date.

Table headings include theorem counts as of 2026-02-13.
