...
**Status**: 469 theorems across 11 categories, all fully proven. 0 `sorry` — Ledger sum proofs completed in Conservation.lean ([#65](https://github.com/Th0rgal/verity/issues/65)). 1 axiom documented in [AXIOMS.md](https://github.com/Th0rgal/verity/blob/main/AXIOMS.md).

## Snapshot (2026-02-17)

- EDSL theorems: 469 across 11 categories (9 contracts + ReentrancyExample + Stdlib).
...
- Stdlib: 197 theorems (Math 25, Automation 56, MappingAutomation 37, ListSum 7, AddressAutomation 24; 2 shared between Automation and MappingAutomation).

## Compiler Proofs (IR + Yul)

- **Spec semantics**: `Verity/Proofs/Stdlib/SpecInterpreter.lean`
- **Spec correctness**: `Compiler/Proofs/SpecCorrectness/` (complete for all 9 contracts — proves each CompilationModel matches its EDSL)
