...
15/19 builtins have compile-time agreement proofs (`native_decide`) between Verity and EVMYulLean evaluation paths. The remaining 4 are state-dependent or Verity-specific helpers that remain on the Verity evaluation path.
