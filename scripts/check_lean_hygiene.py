...
def main() -> None:
    ...
    expected_sorry = 456  # 15 Morpho admin tail + 5 SourceSemantics (Lean 4.22 equation lemma heartbeat cap) + 66 FunctionBody (evalExpr Option Nat migration) + 255 GenericInduction + 45 Function + 22 Dispatch + 48 Contract (sorry-based migration)
    sorry_count = 0
