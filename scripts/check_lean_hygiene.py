...
def main() -> None:
    ...
    expected_sorry = 398  # 15 Morpho admin tail + 5 SourceSemantics (Lean 4.22 equation lemma heartbeat cap) + 66 FunctionBody (evalExpr Option Nat migration) + 255 GenericInduction + 41 Function + 7 Dispatch + 9 Contract (sorry-based migration)
    sorry_count = 0
