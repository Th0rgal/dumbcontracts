...
def main() -> None:
    ...
    expected_sorry = 337  # 15 Morpho admin tail + 5 SourceSemantics (Lean 4.22 equation lemma heartbeat cap) + 66 FunctionBody (evalExpr Option Nat migration) + 201 GenericInduction + 41 Function + 7 Dispatch + 2 Contract (sorry-based migration)
    sorry_count = 0
