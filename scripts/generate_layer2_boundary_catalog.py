        ...
        "supported_spec_split": {
            ...
            "helper_boundary": {
                ...
                "next_required_proof_step": (
                    "next prove the stmt compatibility slice of "
                    "InterpretIRWithInternalsZeroConservativeExtensionInterfaces "
                    ...
                    "of_stmtCompatibility, and "
                    "interpretIRWithInternalsZeroConservativeExtensionGoal_"
                    "of_stmtCompatibility on the legacy-compatible "
                    "external-body Yul subset generated by the current "
                    "supported fragment. The remaining semantic work is no "
                    "longer generic expr/list plumbing: it is concentrated in "
                    "the special expression-statement cases (`sstore`, "
                    "`mstore`, `return`, `revert`) plus nested `if`/`block` "
                    "transport on that Yul subset, "
