        ...
        "supported_spec_split": {
            ...
            "helper_boundary": {
                ...
                "next_required_proof_step": (
                    ...
                    "expr/list plumbing: `IRInterpreter.lean` now already has "
                    "direct helper-free lemmas for `mstore`, `revert`, "
                    "`return`, and mapping-slot `sstore`, so the open assembly "
                    "is the full `expr` compatibility theorem plus nested "
                    "`if`/`block` transport on that Yul subset, "
