        ...
        "supported_spec_split": {
            ...
            "helper_boundary": {
                ...
                "next_required_proof_step": (
                    ...
                    "supported fragment, then retarget body/dispatch/contract "
                    "preservation lemmas to the helper-aware IR execution "
                    "target (execIRFunctionWithInternals / "
                ...
                "blocking_seams": [
                    ...
                    },
                    {
                        ...
                        "status": (
                            "the repo still needs an explicit conservative-"
                            "extension theorem over the helper-free "
                            "external-body Yul subset generated by today's "
                            "supported fragment before the public theorem stack "
