...
**Coverage**: 250/273 theorems tested (92%), 23 proof-only exclusions documented in `property_exclusions.json`.
...
```
test/
├── Property*.t.sol           # Property tests (234 functions, covering 250/273 theorems)
