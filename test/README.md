...
**Coverage**: 250/425 theorems tested (59%), 175 proof-only exclusions documented in `property_exclusions.json`.
...
```
test/
├── Property*.t.sol           # Property tests (234 functions, covering 250/425 theorems)
